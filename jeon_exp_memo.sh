...
echo "valgrind --tool=massif --massif-out-file=outputs/memo_outputs/jeonmemo_2D_GaussianDisc_5K_4th.out ./multi-threaded-NN-chain/NN-chain ./datasets/2D_GaussianDisc_3K.pbbs 5000 2 3 1 4 1 > outputs/memo_outputs/jeonmemo_2D_GaussianDisc_5K_4th.txt"
valgrind --tool=massif --massif-out-file=outputs/memo_outputs/jeonmemo_2D_GaussianDisc_5K_4th.out ./multi-threaded-NN-chain/NN-chain ./datasets/2D_GaussianDisc_3K.pbbs 5000 2 3 1 4 1 > outputs/memo_outputs/jeonmemo_2D_GaussianDisc_5K_4th.txt
