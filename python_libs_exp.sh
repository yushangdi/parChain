...
[ -d "outputs/outputs_fastcluster" ] || mkdir "outputs/outputs_fastcluster"

echo "python3 python_benchmark_fastcluster.py 10D_UCI1_19K all > outputs/outputs_fastcluster/fastcluster_10D_UCI1_19K_1th.txt"
python3 python_benchmark_fastcluster.py 10D_UCI1_19K all > outputs/outputs_fastcluster/fastcluster_10D_UCI1_19K_1th.txt

echo "python3 python_benchmark_fastcluster.py 10D_UCI4_100K all > outputs/outputs_fastcluster/fastcluster_10D_UCI4_100K_1th.txt"
python3 python_benchmark_fastcluster.py 10D_UCI4_100K all > outputs/outputs_fastcluster/fastcluster_10D_UCI4_100K_1th.txt

echo "python3 python_benchmark_fastcluster.py 2D_GaussianDisc_10K all > outputs/outputs_fastcluster/fastcluster_2D_GaussianDisc_10K_1th.txt"
python3 python_benchmark_fastcluster.py 2D_GaussianDisc_10K all > outputs/outputs_fastcluster/fastcluster_2D_GaussianDisc_10K_1th.txt
